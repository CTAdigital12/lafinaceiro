  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="md:pl-16 lg:pl-64 transition-all duration-300">
        ...
        {/*
          BottomNav (mobile-only) is `fixed bottom-0`. Its visual height
          includes h-16 + pb-safe + FAB sticking out (~24px). The custom
          `.pb-bottom-nav` utility (in src/index.css) handles the math.
          Desktop has no BottomNav, so md:pb-6 stays.
        */}
        <main className="p-4 md:p-6 pb-bottom-nav md:pb-6">{children}</main>
      </div>
